...
/**
 * Manage the sharing options in RSSServer.
 */
class RSSServer_Share {
	/**
	...
	public static function register($share_options) {
		...
		self::$list_sharing[$type] = new RSSServer_Share(
	 ...
	 * @return an array of RSSServer_Share objects.
	 */
	...
	/**
	 * Return RSSServer_Share object related to the given type.
	...
	/**
	 * Create a RSSServer_Share object.
	...
	/**
	 * Update a RSSServer_Share object with information from an array.
