...
return array(
	'action' => array(
		...
		'reinstall' => 'RSSServer i yeniden yükle',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Kontroller',
		'already_installed' => 'RSSServer zaten yüklü!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'Base template eksik.',
			'ok' => 'Base template sorunsuz.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'PHP versiyonunuz %s fakat RSSServer için gerekli olan en düşük sürüm %s.',
			'ok' => 'PHP versiyonunuz %s, RSSServer ile tam uyumlu.',
		),
		'users' => array(
	...
	'fix_errors_before' => 'Lütfen sonraki adıma geçmek için hataları düzeltin.',
	'javascript_is_better' => 'RSSServer JavaScript ile daha işlevseldir',
	'js' => array(
		'confirm_reinstall' => 'RSSServer i yeniden kurarak önceki yapılandırma ayarlarınızı kaybedeceksiniz. Devam etmek istiyor musunuz ?',
	),
	'language' => array(
		'_' => 'Dil',
		'choose' => 'RSSServer için bir dil seçin',
