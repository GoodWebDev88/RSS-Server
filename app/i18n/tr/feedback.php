...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s gösterilemiyor. Detaylar için <a href="%s">RSSServer log kayıtlarını</a> kontrol edin.',
			'ok' => '%s pasif',
		),
		'enable' => array(
			'ko' => '%s aktifleştirilemiyor. Detaylar için <a href="%s">RSSServer log kayıtlarını</a> kontrol edin.',
			'ok' => '%s aktif',
		),
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'RSS akışı eklenemiyor. Detaylar için <a href="%s">RSSServer log kayıtlarını</a> kontrol edin.',
	...
	'update' => array(
		'can_apply' => 'RSSServer <strong>%s versiyonuna</strong> güncellenecek.',
