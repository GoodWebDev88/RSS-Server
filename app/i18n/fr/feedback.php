...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s ne peut pas être désactivée. <a href="%s">Consulter les logs de RSSServer</a> pour plus de détails.',
			'ok' => '%s est désormais désactivée',
		),
		'enable' => array(
			'ko' => '%s ne peut pas être activée. <a href="%s">Consulter les logs de RSSServer</a> pour plus de détails.',
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'Le flux ne peut pas être ajouté. <a href="%s">Consulter les logs de RSSServer</a> pour plus de détails. Vous pouvez essayer de forcer l’ajout par addition de <code>#force_feed</code> à l’URL.',
	...
	'update' => array(
		'can_apply' => 'RSSServer va maintenant être mis à jour vers la <strong>version %s</strong>.',
