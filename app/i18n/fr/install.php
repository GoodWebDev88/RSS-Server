...
return array(
	'action' => array(
		...
		'reinstall' => 'Réinstaller RSSServer',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Vérifications',
		'already_installed' => 'RSSServer semble avoir déjà été installé !',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'Vous ne disposez pas de la template Base.',
			'ok' => 'Vous disposez du template Base',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Votre version de PHP est la %s mais RSSServer requiert au moins la version %s.',
			'ok' => 'Votre version de PHP est la %s, qui est compatible avec RSSServer.',
		),
		'users' => array(
	...
	'fix_errors_before' => 'Veuillez corriger les erreurs avant de passer à l’étape suivante.',
	'javascript_is_better' => 'RSSServer est plus agréable à utiliser avec JavaScript activé',
	'js' => array(
		'confirm_reinstall' => 'Réinstaller RSSServer vous fera perdre la configuration précédente. Êtes-vous sûr de vouloir continuer ?',
	),
	'language' => array(
		'_' => 'Langue',
		'choose' => 'Choisissez la langue pour RSSServer',
