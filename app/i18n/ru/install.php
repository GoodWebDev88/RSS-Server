...
return array(
	'action' => array(
		...
		'reinstall' => 'Переустановить RSSServer',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Проверки',
		'already_installed' => 'Обнаружена предыдущая установка RSSServer!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'У вас не установлен фрейворк Base.',
			'ok' => 'У вас установлен фрейворк Base.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'У вас установлен PHP версии %s, но RSSServer необходима версия не ниже %s.',
			'ok' => 'У вас установлен PHP версии %s, который совместим с RSSServer.',
		),
		'users' => array(
	...
	'fix_errors_before' => 'Пожалуйста, исправьте ошибки прежде чем переходить	к следующему этапу..',
	'javascript_is_better' => 'RSSServer принесёт больше удовольствия, если включить JavaScript',
	'js' => array(
		'confirm_reinstall' => 'Переустанавливая RSSServer, вы потеряете предыдущую конфигурацию. Вы хотите продолжить?',
	),
	'language' => array(
		'_' => 'Язык',
		'choose' => 'Выберите язык для RSSServer',
		'defined' => 'Язык выбран.',
	),
