...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s cannot be disabled. <a href="%s">Check RSSServer logs</a> for details.',	// TODO - Translation
			'ok' => '%s is now disabled',	// TODO - Translation
		),
		'enable' => array(
			'ko' => '%s cannot be enabled. <a href="%s">Check RSSServer logs</a> for details.',	// TODO - Translation
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'The newsfeed could not be added. <a href="%s">Check RSSServer logs</a> for details. You can try force adding by appending <code>#force_feed</code> to the URL.',	// TODO - Translation
	...
	'update' => array(
		'can_apply' => 'RSSServer will now be updated to the <strong>version %s</strong>.',	// TODO - Translation
