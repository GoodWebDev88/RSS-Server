...
return array(
	...
	'check' => array(
		'_' => '설치 요구사항 확인',
		'already_installed' => 'RSSServer가 이미 설치되어 있는 것을 감지했습니다!',
		'cache' => array(
		...
		'php' => array(
			'nok' => 'PHP 버전은 %s 이지만, RSSServer에는 최소 %s의 버전이 필요합니다.',
			'ok' => 'PHP 버전은 %s 이고, RSSServer와 호환가능 합니다.',
		),
		'users' => array(
	...
	'fix_errors_before' => '다음 단계로 가기 전에 문제를 해결하세요.',
	'javascript_is_better' => 'RSSServer는 자바스크립트를 사용할 때 더욱 쾌적하고 강력합니다',
	'js' => array(
		'confirm_reinstall' => 'RSSServer을 다시 설치하면 이전 설정이 사라집니다. 계속하시겠습니까?',
	),
	'language' => array(
		'_' => '언어',
		'choose' => 'RSSServer에서 사용할 언어를 고르세요',
		'defined' => '언어가 설정되었습니다.',
	),
