...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s 확장 기능을 비활성화 할 수 없습니다. 자세한 내용은 <a href="%s">RSSServer 로그</a>를 참고하세요.',
			'ok' => '%s 확장 기능이 비활성화되었습니다',
		),
		'enable' => array(
			'ko' => '%s 확장 기능을 활성화 할 수 없습니다. 자세한 내용은 <a href="%s">RSSServer 로그</a>를 참고하세요.',
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'RSS 피드를 추가할 수 없습니다. 자세한 내용은 <a href="%s">RSSServer 로그</a>를 참고하세요.',
	...
	'update' => array(
		'can_apply' => 'RSSServer가 <strong>%s</strong> 버전으로 업데이트됩니다.',
