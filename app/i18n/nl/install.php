...
return array(
	'action' => array(
		...
		'reinstall' => 'Installeer RSSServer opnieuw',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Controles',
		'already_installed' => 'We hebben geconstateerd dat RSSServer al is geïnstallerd!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'U mist het Base template.',
			'ok' => 'U hebt het Base template.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Uw PHP versie is %s maar RSSServer benodigd tenminste versie %s.',
			'ok' => 'Uw PHP versie is %s, welke compatibel is met RSSServer.',
		),
		'users' => array(
	...
	'javascript_is_better' => 'RSSServer werkt beter JavaScript ingeschakeld',
	'js' => array(
		'confirm_reinstall' => 'U zal uw vorige configuratie kwijtraken door RSSServer opnieuw te installeren. Weet u zeker dat u verder wilt gaan?',
	),
	'language' => array(
		'_' => 'Taal',
		'choose' => 'Kies een taal voor RSSServer',
