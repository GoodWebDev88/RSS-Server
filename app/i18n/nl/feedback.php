...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s kan niet worden uitgeschakeld. <a href="%s">Controleer RSSServer log bestanden</a> voor details.',
			'ok' => '%s is nu uitgeschakeld',
		),
		'enable' => array(
			'ko' => '%s kan niet worden ingeschakeld. <a href="%s">Controleer RSSServer log bestanden</a> voor details.',
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'De feed kon niet worden toegevoegd. <a href="%s">Controleer de RSSServer-logbestanden</a> voor details. Toevoegen forceren kan worden geprobeerd door <code>#force_feed</code> aan de URL toe te voegen.',
	...
	'update' => array(
		'can_apply' => 'RSSServer word nu vernieud naar <strong>versie %s</strong>.',
