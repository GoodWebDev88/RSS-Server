...
return array(
	'action' => array(
		...
		'reinstall' => 'Reinstalla RSSServer',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Controlli',
		'already_installed' => 'RSSServer risulta già installato!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'Manca il template Base.',
			'ok' => 'Template Base presente.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Versione di PHP %s RSSServer richiede almeno la versione %s.',
			'ok' => 'Versione di PHP %s, compatibile con RSSServer.',
		),
		'users' => array(
	...
	'fix_errors_before' => 'Per favore correggi gli errori prima di passare al passaggio successivo.',
	'javascript_is_better' => 'RSSServer funziona meglio con JavaScript abilitato',
	'js' => array(
		'confirm_reinstall' => 'Reinstallando RSSServer perderai la configurazione precedente. Sei sicuro di voler procedere?',
	),
	'language' => array(
		'_' => 'Lingua',
		'choose' => 'Seleziona la lingua per RSSServer',
