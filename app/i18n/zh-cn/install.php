...
return array(
	...
	'check' => array(
		'_' => '检查',
		'already_installed' => '我们检测到 RSSServer 已经安装！',
		'cache' => array(
		...
		'php' => array(
			'nok' => '你的 PHP 版本为 %s，但 RSSServer 最低需要 %s',
			'ok' => '你的 PHP 版本为 %s，与 RSSServer 兼容',
		),
		'users' => array(
	...
	'fix_errors_before' => '请在继续下一步前修复错误',
	'javascript_is_better' => '启用 JavaScript 会使 RSSServer 工作得更好',
	'js' => array(
		'confirm_reinstall' => '重新安装 RSSServer 将会重置之前的配置。你确定要继续吗？',
	),
	'language' => array(
		'_' => '语言',
		'choose' => '为 RSSServer 选择语言',
		'defined' => '语言已指定',
	),
