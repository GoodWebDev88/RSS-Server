...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s sa nepodarilo nainštalovať. <a href="%s">Prečítajte si záznamy RSSServer</a>, ak chcete poznať podrobnosti.',
			'ok' => '%s je teraz zakázaný',
		),
		'enable' => array(
			'ko' => '%s sa nepodarilo povoliť. <a href="%s">Prečítajte si záznamy RSSServer</a>, ak chcete poznať podrobnosti.',
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'Kanál sa nepodarilo pridať. <a href="%s">Prečítajte si záznamy RSSServer</a>, ak chcete poznať podrobnosti. Skúste pridať kanál pomocou <code>#force_feed</code> v odkaze (URL).',
	...
	'update' => array(
		'can_apply' => 'RSSServer sa teraz aktualizuje <strong>na verziu %s</strong>.',
