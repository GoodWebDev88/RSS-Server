...
return array(
	'action' => array(
		...
		'reinstall' => 'Preinštalovať RSSServer',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Kontrola',
		'already_installed' => 'Zistilo sa, že RSSServer je už nainštalovaný!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'Nepodarilo sa nájsť template Base.',
			'ok' => 'Našiel sa template Base.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Vaša verzia PHP je %s, ale RSSServer vyžaduje minimálne verziu %s.',
			'ok' => 'Vaša verzia PHP %s je kompatibilná s RSSServer.',
		),
		'users' => array(
	...
	'fix_errors_before' => 'Prosím, pred pokračovaním opravte chyby.',
	'javascript_is_better' => 'RSSServer si užijete viac, keď povolíte JavaScript',
	'js' => array(
		'confirm_reinstall' => 'Ak budete pokračovať v preinštalovaní RSSServer, stratíte vaše predošlé nastavenia. Naozaj chcete pokračovať?',
	),
	'language' => array(
		'_' => 'Jazyk',
		'choose' => 'Vyberte jazyk pre RSSServer',
