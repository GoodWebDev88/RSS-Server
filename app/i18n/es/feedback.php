...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s no se puede desactivar. <a href="%s">Revisa el registro de RSSServer</a> para más información.',
			'ok' => '%s ha quedado desactivado',
		),
		'enable' => array(
			'ko' => '%s no se puede activar. <a href="%s">Revisa el registro de RSSServer</a> para más información.',
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'No ha sido posible agregar la fuente RSS. <a href="%s">Revisa el registro de RSSServer </a> para más información.',
	...
	'update' => array(
		'can_apply' => 'RSSServer se va a actualizar a la <strong>versión %s</strong>.',
