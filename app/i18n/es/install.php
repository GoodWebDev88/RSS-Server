...
return array(
	'action' => array(
		...
		'reinstall' => 'Reinstalar RSSServer',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Verificaciones',
		'already_installed' => '¡RSSServer ya está instalado!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'No se ha podido localizar el entorno Base.',
			'ok' => 'Dispones del entorno Base.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Dispones de la versión PHP %s, pero RSSServer necesita de, al menos, la versión %s.',
			'ok' => 'Dispones de la versión PHP %s, que es compatible con RSSServer.',
		),
		'users' => array(
	...
	'javascript_is_better' => 'RSSServer funciona mejor con JavaScript activado',
	'js' => array(
		'confirm_reinstall' => 'Al reinstalar RSSServer perderás cualquier configuración anterior. ¿Seguro que quieres continuar?',
	),
	'language' => array(
		'_' => 'Idioma',
		'choose' => 'Selecciona el idioma para RSSServer',
