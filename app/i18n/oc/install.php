...
return array(
	'action' => array(
		...
		'reinstall' => 'Reïnstallar RSSServer',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Verificacions',
		'already_installed' => 'Sembla que RSSServer es ja installat !',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'Avètz pas la bibliotèca Base.',
			'ok' => 'Avètz la bibliotèca Base.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Vòstra version PHP es la %s mas RSSServer demanda almens la version %s.',
			'ok' => 'Vòstra version PHP es %s, qu’es compatibla amb RSSServer.',
		),
		'users' => array(
	...
	'fix_errors_before' => 'Mercés de corregir las errors seguentas abans de contunhar.',
	'javascript_is_better' => 'RSSServer es mai agradable amb lo JavaScript activat',
	'js' => array(
		'confirm_reinstall' => 'En reïnstallant RSSServer perdretz la configuracion precedenta. Volètz vertadièrament contunhar ?',
	),
	'language' => array(
		'_' => 'Lenga',
		'choose' => 'Causissètz la lenga per RSSServer',
