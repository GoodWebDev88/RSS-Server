...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s pòt pas èsser desactivada. <a href="%s">Consultatz los jornals d’audit de RSSServer logs</a> per mai de detalhs.',
			'ok' => '%s es ara desactivada',
		),
		'enable' => array(
			'ko' => '%s pòt pas èsser activada. <a href="%s">Consultatz los jornals d’audit de RSSServer logs</a> per mai de detalhs.',
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'Lo flux pòt pas èsser ajustat. <a href="%s">Consultatz los jornals d’audit de RSSServer</a> per ne saber mai. Podètz forçar l’apondon en ajustant <code>#force_feed</code> a l’URL.',
	...
	'update' => array(
		'can_apply' => 'RSSServer es per èsser mes a jorn en <strong>version %s</strong>.',
