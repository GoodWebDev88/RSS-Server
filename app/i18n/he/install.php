...
return array(
	'action' => array(
		...
		'next_step' => 'לשלב הבא',
		'reinstall' => 'Reinstall RSSServer',	// TODO - Translation
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'בדיקות',
		'already_installed' => 'We have detected that RSSServer is already installed!',	// TODO - Translation
		'cache' => array(
		...
		'php' => array(
			'nok' => 'גירסת PHP שלכם היא %s אך RSSServer דורש לפחות את גירסה %s',
			'ok' => 'גירסת PHP שלכם היא %s, שתואמת ל RSSServer',
		),
		'users' => array(
	...
	'fix_errors_before' => 'יש לתקן את השגיאות לפני המעבר לשלב הבא.',
	'javascript_is_better' => 'RSSServer מעדיף שתאפשרו JavaScript',
	'js' => array(
		'confirm_reinstall' => 'You will lose your previous configuration by reinstalling RSSServer. Are you sure you want to continue?',	// TODO - Translation
	),
	'language' => array(
		'_' => 'שפה',
		'choose' => 'בחירת שפה ל RSSServer',
		'defined' => 'השפה הוגדרה.',
	),
