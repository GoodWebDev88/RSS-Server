...
return array(
	...
	'check' => array(
		'_' => 'Checks',
		'already_installed' => 'We have detected that RSSServer is already installed!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'Cannot find the Base template.',
			'ok' => 'You have the Base template.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Your PHP version is %s but RSSServer requires at least version %s.',
			'ok' => 'Your PHP version is %s, which is compatible with RSSServer.',
		),
		'users' => array(
	...
	'fix_errors_before' => 'Please fix errors before skipping to the next step.',
	'javascript_is_better' => 'RSSServer is more pleasant with JavaScript enabled',
	'js' => array(
		'confirm_reinstall' => 'You will lose your previous configuration by reinstalling RSSServer. Are you sure you want to continue?',
	),
	'language' => array(
		'_' => 'Language',
		'choose' => 'Choose a language for RSSServer',
