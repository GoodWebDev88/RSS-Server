...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s nelze vypnout. Pro více detailů <a href="%s">zkontrolujte logy RSSServer</a>.',
			'ok' => '%s je nyní vypnut',
		),
		'enable' => array(
			'ko' => '%s nelze zapnout. Pro více detailů <a href="%s">zkontrolujte logy RSSServer</a>.',
			'ok' => '%s je nyní zapnut',
		),
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'RSS kanál nelze přidat. Pro detaily <a href="%s">zkontrolujte logy RSSServer</a>.',
	...
	'update' => array(
		'can_apply' => 'RSSServer bude nyní upgradováno na <strong>verzi %s</strong>.',
