...
return array(
	...
	'extensions' => array(
		...
		'disable' => array(
			'ko' => '%s não pode ser desabilitado. <a href="%s">verifique os logs do RSSServer</a> para detalhes.',
			'ok' => '%s agora está desabilitado',
		),
		'enable' => array(
			'ko' => '%s não pode ser habilitado. <a href="%s">verifique os logs do RSSServer</a> para detalhes.',
	...
	'sub' => array(
		...
		'feed' => array(
			...
			'internal_problem' => 'O feed RSS não pôde ser adicionado. <a href="%s">Verifique os logs do RSSServer</a> para detalhes.',
	...
	'update' => array(
		'can_apply' => 'O RSSServer será atualizado para a <strong>versão %s</strong>.',
