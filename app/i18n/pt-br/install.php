...
return array(
	'action' => array(
		...
		'reinstall' => 'Reinstale o RSSServer',
	),
	'auth' => array(
	...
	'check' => array(
		'_' => 'Verificações',
		'already_installed' => 'Verificamos que o RSSServer já está instalado!',
		'cache' => array(
		...
		'base' => array(
			'nok' => 'Não foi possível encontrar o template Base.',
			'ok' => 'Você tem o template Base.',
		),
		'pcre' => array(
		...
		'php' => array(
			'nok' => 'Sua versão do PHP é %s mas RSSServer requer ao menos a versão %s.',
			'ok' => 'Sua versão do PHP é %s, que é compatível com o RSSServer.',
		),
		'users' => array(
	...
	'javascript_is_better' => 'O RSSServer é mais agradável com o JavaScript ativo',
	'js' => array(
		'confirm_reinstall' => 'Você irá perder suas configurações anteriores ao reinstalar o RSSServer. Você está certo que deseja continuar?',
	),
	'language' => array(
		'_' => 'Idioma',
		'choose' => 'Escolha o idioma para o RSSServer',
