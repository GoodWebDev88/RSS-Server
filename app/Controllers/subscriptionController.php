 ...
 */
class RSSServer_subscription_Controller extends Minz_ActionController {
	/**
	...
	public function feedAction() {
		...
		if (Minz_Request::isPost()) {
			...
			$ttl = intval(Minz_Request::param('ttl', RSSServer_Feed::TTL_DEFAULT));
			...
			$values = array(
				...
				'priority' => intval(Minz_Request::param('priority', RSSServer_Feed::PRIORITY_MAIN_STREAM)),
				'httpAuth' => $httpAuth,
				'ttl' => $ttl * ($mute ? -1 : 1),
