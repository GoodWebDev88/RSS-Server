...
foreach ($users as $username) {
	...
	$data = array(
		'is_default' => $username === RSSServer_Context::$system_conf->default_user ? '*' : '',
		'user' => $username,
		'last_user_activity' => RSSServer_UserDAO::mtime($username),
