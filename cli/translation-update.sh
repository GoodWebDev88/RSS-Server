...
echo 'Generating configuration file for po4a...'
{
	...
	echo '[po4a_paths] i18n/templates/rssserver.pot $lang:i18n/rssserver.$lang.po'
} >$CONFIGFILE
...
po4a -k 0 --msgid-bugs-address 'https://github.com/RSSServer/RSSServer/issues' $CONFIGFILE
