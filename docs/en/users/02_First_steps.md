Learning how to handle a new application is not always easy. We've tried to make RSSServer as intuitive as possible, but you might still need a little help to master the program.
