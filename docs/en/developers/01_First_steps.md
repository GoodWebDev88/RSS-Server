...
**You can now access RSSServer at [http://localhost:8080](http://localhost:8080).** Just follow the install process and select the SQLite database.
...
You can find the full list of available tags [on the Docker hub](https://hub.docker.com/r/rssserver/rssserver/tags).
...
If you want to create your own RSSServer extension, take a look at the [extension documentation](03_Backend/05_Extensions.md).
...
Please ensure that your code works with the oldest PHP version officially supported by RSSServer.
