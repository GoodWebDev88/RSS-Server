...
6. Sur la même page de l'API RSSServer, notez l'adresse donnée sous "Votre adresse API", comme `https://rssserver.example.net/api/greader.php`
...
7. Vous pouvez maintenant tester sur une application mobile:
	* Android
		...
		* [EasyRSS](https://github.com/Alkarex/EasyRSS) (Libre, [F-Droid](https://f-droid.org/packages/org.rssserver.easyrss/))
	* Linux
	...
	* iOS
		* [Reeder](https://www.reederapp.com/) (Commercial)
	* Firefox
		* [RSSServer-Notify](https://addons.mozilla.org/firefox/addon/rssserver-notify-webextension/) (Libre)
