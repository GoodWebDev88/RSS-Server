...
function init_afterDOM() {
	rendered_node = document.getElementById('rssserver_rendered');
	rendered_view = document.getElementById('rssserver_rendered_view');

	raw_node = document.getElementById('rssserver_raw');
	raw_view = document.getElementById('rssserver_raw_view');
